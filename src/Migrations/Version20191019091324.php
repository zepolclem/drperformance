 ...
 */
final class Version20191019091324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE engine (id INT AUTO_INCREMENT NOT NULL, generation_id INT NOT NULL, power INT DEFAULT NULL, torque INT DEFAULT NULL, energy ENUM(\'GAS\', \'DIE\', \'ELE\') DEFAULT NULL COMMENT \'(DC2Type:EngineEnergyType)\', cylinder_capacity INT DEFAULT NULL, turbo TINYINT(1) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_E8A81A8D553A6EC4 (generation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE map (id INT AUTO_INCREMENT NOT NULL, engine_id INT NOT NULL, power INT DEFAULT NULL, torque INT DEFAULT NULL, resume LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_93ADAABBE78C9C0A (engine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE model (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, resume LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_D79572D9A23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE manufacturer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, resume LONGTEXT DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
