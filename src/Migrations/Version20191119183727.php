 ...
 */
final class Version20191119183727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE achievement (id INT AUTO_INCREMENT NOT NULL, map_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_96737FF153C55F64 (map_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE manufacturer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, resume LONGTEXT DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, type_vehicle ENUM(\'CAR\', \'BIKE\', \'ATV\', \'JET\') DEFAULT NULL COMMENT \'(DC2Type:VehicleType)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE achievement ADD CONSTRAINT FK_96737FF153C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE achievement DROP FOREIGN KEY FK_96737FF153C55F64');
