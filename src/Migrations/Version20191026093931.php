 ...
 */
final class Version20191026093931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE manufacturer ADD type_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE manufacturer ADD CONSTRAINT FK_3D0AE6DCC54C8C93 FOREIGN KEY (type_id) REFERENCES type_vehicle (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE manufacturer DROP type_id');
    }
}
